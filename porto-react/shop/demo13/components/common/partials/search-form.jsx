...
function SearchForm(props) {
    ...
    return (
        <div className={`header-icon header-search header-search-inline header-search-category pr-lg-4 w-lg-max ${props.sticky ? '' : 'mr-lg-5'}`}>
            ...
            <form action="#" method="get" onSubmit={(e) => onSubmitSearchForm(e)}>
                <div className="header-search-wrapper">
                    ...
                    <button className="btn icon-search-3" title="search" type="submit"></button>
