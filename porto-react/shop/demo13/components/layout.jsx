    ...
    return (
        <>
            <div className="page-wrapper">
                {
                    showTopNotice ?
                        <div className="top-notice text-white bg-secondary overflow-hidden">
                            <div className="container text-center">
                                <h5 className="d-inline-block mb-0">Get Up to <b>40% OFF</b> New-Season Styles</h5>
                                <ALink href="/shop" className="category">MEN</ALink>
                                <ALink href="/shop" className="category second-caty">WOMEN</ALink>
