                            ...
                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                <li>
                                    ...
                                    <ul className="overflow-hidden" ref={ setCollapsibleElement }>
                                        <li>
                                            <ALink href={ { pathname: "/shop", query: { category: "trousers-3" } } } scroll={ false }>Women Clothes</ALink>
                                        </li>
                                        <li>
                                            <ALink href={ { pathname: "/shop", query: { category: "t-shirts" } } } scroll={ false }>Men Clothes</ALink>
                                        </li>
                                        <li>

                                            <ALink href={ { pathname: "/shop", query: { category: "shoes-1" } } } scroll={ false }>Shoes</ALink>
                                        </li>
                                        <li>
                        ...
                        <SlideToggle collapsed={ true }>
                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                <li>
                                    ...
                                    <ul className="overflow-hidden" ref={ setCollapsibleElement }>
                                        <li>
                                            <ALink href={ { pathname: "/shop", query: { category: "watches-2" } } } scroll={ false }>Watches</ALink>
                                        </li>
                                        <li>
                                            <ALink href={ { pathname: "/shop", query: { category: "caps" } } } scroll={ false }>Caps</ALink>
                                        </li>
                                    </ul>
                                </li>
                            ) }
                        ...
                        <SlideToggle collapsed={ true }>
                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                <li>
                                    ...
                                    <ul className="overflow-hidden" ref={ setCollapsibleElement }>
                                        <li>
                                            <ALink href={ { pathname: "/shop", query: { category: "toys-1" } } } scroll={ false }>Toys</ALink>
                                        </li>
                                        <li>
