...
function SearchForm ( props ) {
    ...
    return (
        <div className="header-search header-search-popup header-search-category header-icon text-dark">
            <a href="#" className="search-toggle btn p-0 icon-magnifier" role="button" onClick={ onSearchClick }></a>

            <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control bg-white" name="q" id={ `${props.type === 1 ? 'q' : 'qqq'}` } placeholder="Search..." value={ search }
                        required onChange={ ( e ) => onSearchChange( e ) } />

                    <button className="btn icon-magnifier bg-transparent p-0 border-0" title="search" type="submit"></button>
