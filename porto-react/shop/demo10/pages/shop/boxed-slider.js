            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-xl-9 col-lg-8 main-content">
                        <OwlCarousel adClass="boxed-slider owl-carousel shop-slider owl-carousel-lazy owl-theme owl-theme-light mb-2" options={ {
                            nav: false
                        } }>
                            <div className="boxed-slide boxed-slide-1" style={ { backgroundColor: '#9ee3f2' } }>
                                <figure>
                                    <img className="slide-bg" src="images/banners/banner-fashion-1.jpg" alt="banner" width="870"
                                        height="300" />
                                </figure>
                            ...
                            <div className="boxed-slide boxed-slide-2">
                                <figure>
                                    <img className="slide-bg" src="images/banners/banner-fashion-2.jpg" alt="banner" width="870"
                                        height="300" />
                                </figure>
                                <div className="slide-content">
