...
function ShopHorizontalOne () {
    ...
    return (
        <main className="main horizontal-one">
            <ShopBanner nogap={ true } />
            ...
            <div className="container">
                <nav className="toolbox sticky-header horizontal-filter mb-1 mobile-sticky">
                ...
                <div className="row main-content-wrap sidebar-hidden">
                    <ShopSidebarOne adClass="pt-0" gridCol={ true } />
