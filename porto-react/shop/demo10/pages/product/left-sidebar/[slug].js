        ...
        <main className="main">
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className={ `col-xl-9 col-lg-8 main-content pb-2 skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                        <div className="product-single-container product-single-default product-left-sidebar">
                            <div className="row">
                                <ProductMediaOne product={ product } adClass="col-xl-7 col-lg-12 col-md-6" />
                                <ProductDetailOne
