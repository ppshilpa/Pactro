...
function ProductSidebarOne ( props ) {
    ...
    return (
        <>
            ...
            <aside className={ `sidebar-product col-xl-3 col-lg-4 mobile-sidebar skeleton-body skel-shop-products ${ adClass } ${ loading ? '' : 'loaded' }` }>
                <StickyBox className="sticky-wrapper" offsetTop={ 55 }>
                    {
                        loading ?
