...
function ShopSidebarOne ( props ) {
    ...
    return (
        <>
            ...
            <aside className={ `sidebar-shop ${ gridCol ? 'col-lg-3' : 'col-xl-3 col-lg-4' }  mobile-sidebar skeleton-body skel-shop-products ${ !loading ? 'loaded' : '' } ${ props.display === 'none' ? 'd-lg-none' : '' } ${ props.right ? '' : 'order-lg-first' }` }>
