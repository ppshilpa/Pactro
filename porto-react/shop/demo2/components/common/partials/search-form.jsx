...
function SearchForm(props) {
    ...
    return (
        <div className={`header-icon header-search header-search-inline header-search-category w-lg-max ${stickystate ? 'pl-3 pr-1 mb-0' : ''}`}>
            ...
            <form action="#" method="get" onSubmit={(e) => onSubmitSearchForm(e)}>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control bg-white" placeholder="Search..." value={search}
                    ...
                    <button className="btn icon-magnifier pb-1 bg-white" title="search" type="submit"></button>
