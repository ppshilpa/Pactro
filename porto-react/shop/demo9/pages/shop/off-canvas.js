...
function OffCanvas () {
    ...
    return (
        <main className="main">
            <div className="container shop-off-canvas">
                <ShopBanner />
                ...
                <div className="row">
                    <div className="col-lg-12 main-content">
                        <nav className="toolbox sticky-header mobile-sticky">
                            <div className="toolbox-left mb-lg-1">
                        ...
                        <ProductsGrid products={ products } loading={ loading } perPage={ perPage } gridClass="col-6 col-md-4" />

                        { loading || ( products && products.length ) ?
                            <nav className="toolbox toolbox-pagination">
                                <div className="toolbox-item toolbox-show mr-auto">
                                    <label>Show:</label>
