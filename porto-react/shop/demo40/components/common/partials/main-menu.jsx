    ...
    return (
        <>
            <nav className="side-nav">
                <ul className="menu menu-vertical main-vertical custom-menu sf-arrows d-block pb-0 sf-js-enabled">
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/fresh-dressed-meat" >Products<span className="sf-with-ul menu-btn"></span></ALink>
                    ...
                    <li className={ isOtherPage() ? 'active' : '' }>
                        <ALink href="#">Pages<span className="sf-with-ul menu-btn"></span></ALink>
                        <ul>
                            {
