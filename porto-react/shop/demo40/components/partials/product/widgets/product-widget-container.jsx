...
function ProductWidgetContainer ( props ) {
    ...
    return (
        <section className={ `product-widgets-container custom-widgets skeleton-body skel-shop-products ${loading ? '' : 'loaded'} ${adClass}` }>
            <div className="row">
                <div className="col-xl-3 col-sm-6 pb-5 pb-xl-0">
                    {
                        loading ?
                ...
                <div className="col-xl-3 col-sm-6 pb-0">
                    {
                        loading ?
                            [ 0, 1, 2 ].map( ( item, index ) =>
                                <div className="skel-product-col skel-pro mb-2" key={ "ProductThree" + index }></div>
