...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int) {
        meatAndSeafood: products(demo: ${DEMO}, category: "meat-and-seafood", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
        milkAndCheese: products(demo: ${DEMO}, category: "bread-and-bakery", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
        fruits: products(demo: ${DEMO}, category: "fruits-2", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
