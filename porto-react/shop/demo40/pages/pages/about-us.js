...
function AboutUs () {
    ...
    return (
        <div className="about">
            <div className="page-header page-header-bg text-left pl-5"
            ...
            <div className="features-section bg-gray pl-5 pr-5">
            ...
            <div className="testimonials-section pl-5 pr-5">
            ...
            <div className="counters-section bg-gray pl-5 pr-5 mb-7">
                <div className="row">
