...
function ProductStickyInfo () {
    ...
    return (
        <div>
                ...
                <div className={ `product-single-container product-single-default product-single-info` }>
                    <div className="row">
                        ...
                        <div className="col-lg-7 col-md-6">
                            <StickyBox className="sticky-wrapper sticky-sidebar" offsetTop={ 10 }>
                                <ProductDetailOne
                                    adClass=""
                                    product={ product }
            ...
            <SingleTabFive
                adClass={ `custom-product-single-tabs pt-0 mb-1 skeleton-body  skel-shop-products ${ loading ? '' : 'loaded' }` }
                product={ product }
            />

            <RelatedProducts
                adClass={ `skeleton-body skel-shop-products border-0 pb-4 ${ loading ? '' : 'loaded' }` }
                loading={ loading }
                products={ related }
            />
