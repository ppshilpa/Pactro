        ...
        <div>
            ...
            <div className={ `skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                <div className={ `product-single-container product-single-default product-center-vertical` }>
                    <div className="row">
                        <ProductDetailFive
                            adClassOne="order-1 order-xl-0"
                            adClassTwo="order-2 order-xl-2"
                            type="1"
                            product={ product }
                        ...
                        <ProductMediaSeven
                            adClass="col-xl-6 d-xl-flex order-0 order-xl-0"
                            subClass="col-xl-12"
                            product={ product }
                        />
                    </div>
                ...
                <RelatedProducts className="pb-4" products={ related } loading={ loading } />
