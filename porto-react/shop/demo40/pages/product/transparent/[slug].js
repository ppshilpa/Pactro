...
function ProductTransparent () {
    ...
    return (
        <div>
            ...
            <div className={ `product-single-container product-single-default product-transparent-image pb-3  skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                <div className="row">
            ...
            <div className={ `skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                ...
                <RelatedProducts adClass="pb-4" products={ related } loading={ loading } />
