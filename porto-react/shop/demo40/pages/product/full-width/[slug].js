    ...
    return (
        <div>
            ...
            <div className={ `product-single-container product-single-default product-full-width skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` } style={ { minHeight: '1000px' } }>
                <div className="pl-xl-0 padding-right-xl">
                    <div className="row">
                        <ProductMediaFour adClass="col-xl-6" product={ product } />

                        <div className="col-xl-6 pb-1">
                            <ProductDetailFour
                                product={ product }
            ...
            <div className={ `skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` }>
                <RelatedProducts adClass="border-0 pb-4" products={ related } loading={ loading } />
            </div>
