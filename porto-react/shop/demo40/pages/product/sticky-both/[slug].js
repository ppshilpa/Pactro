...
function ProductStickyBoth () {
    ...
    return (
        <div>
            ...
            <div className={ `skeleton-body skel-shop-products ${ loading ? '' : 'loaded' }` }>
                <div className={ `product-single-container product-single-default product-both-info` }>
                    ...
                    <div className="row mb-xl-3">
                        ...
                        <ProductMediaFive product={ product } adClass="col-xl-6 mb-xl-0" subClass="col-xl-12" />
                    </div>
                </div>
            </div>
            ...
            <RelatedProducts adClass={ `skeleton-body skel-shop-products pb-4 border-0 ${ loading ? '' : 'loaded' }` } products={ related } loading={ loading } />
