        ...
        <div className="header-icon header-search header-search-inline d-sm-block d-none w-lg-max">
            ...
            <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                <div className="header-search-wrapper submit-wrapper">
                    <input type="search" className="form-control font2" name="q1" id={ `${props.type === 1 ? 'q' : 'q1'}` } placeholder="Search..." value={ search }
                        required onChange={ ( e ) => onSearchChange( e ) } />

                    <button className="btn" title="search" type="submit"><i className="icon-search-3"></i></button>
