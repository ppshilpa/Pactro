    ...
    return (
        <div className={ `product-default media-with-lazy ${adClass}` }>
            ...
            <div className="product-details">
                ...
                {
                    product.variants.length > 0 ?
                        <ALink href={ `/product/default/${product.slug}` } className="btn-icon btn-add-cart d-flex align-items-center justify-content-center"><i
                            className="fa fa-arrow-right pt-1"></i><span>SELECT OPTIONS</span></ALink>
...
export default connect( mapStateToProps, { ...WishlistAction, ...CartAction, ...ModalAction } )( React.memo( ProductSix ) );