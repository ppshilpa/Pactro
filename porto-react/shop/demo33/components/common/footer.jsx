        ...
        <footer className="footer font2">
            <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-5 m-b-4">
                            <ALink href="/" className="logo">
                                <img src="images/home/footer-logo.png" width="115" height="42" alt="Logo" />
                            </ALink>

                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent pulvinar feugiat quam, vitae
                                aliquam urna egestas nec. sit amet</p>
                            ...
                            <div className="row ls-0">
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <img src="images/home/payments.jpg" alt="payment methods" className="footer-payments m-b-3" width="186" height="27" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-sm-4 m-b-4">
                            <div className="widget">
                                ...
                                <ul className="links">
                                    ...
                                    <li>
                                        <ALink href="#">40 Unique Shop Demos</ALink>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div className="footer-bottom d-flex justify-content-between align-items-center flex-wrap">
                    <p className="footer-copyright py-3 pr-4 mb-0">Porto eCommerce. &copy; 2021. All Rights Reserved</p>
