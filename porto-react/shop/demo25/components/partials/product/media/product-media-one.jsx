...
export default function ProductMediaOne ( props ) {
    const { adClass = 'col-md-6', product, parent = ".product-single-default" } = props;
            ...
            <div className="skel-pro skel-magnifier"></div>
            {
                product && <>
                    <div className="product-slider-container">
                        ...
                        <OwlCarousel adClass="product-single-carousel owl-theme show-nav-hover" options={ productSingleSlider } events={ events } onChangeRef={ setMediaRef } redraw={ redraw }>
                            {
                                product.large_pictures.map( ( item, index ) => (
                                    <div className="product-item" key={ `product-item-${index}` }>
                                        <Magnifier
                                            style={ { paddingTop: "149.95%", position: "relative" } }
                    ...
                    <OwlCarousel adClass="prod-thumbnail owl-dots" options={ prodThumbSlider }>
                        {
