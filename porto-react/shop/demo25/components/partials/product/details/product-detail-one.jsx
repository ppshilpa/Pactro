...
function ProductDetailOne ( props ) {
    ...
    const { product, adClass = "col-md-6", prev, next, isNav = true, parent = ".product-single-default", isSticky = false } = props;
    ...
    return (
        <>
            ...
            {
                product &&
                <div className={ `product-single-details font2 ${ adClass }` }>
