    ...
    return (
        <main className="main">
            ...
            <div className="bg-white pt-5">
                <div className={ `product-single-container product-single-default product-full-width pt-2 skeleton-body skel-shop-products ${loading ? '' : 'loaded'}` } style={ { minHeight: '1000px' } }>
