            ...
            <nav className="main-nav">
                <ul className="menu sf-js-enabled sf-arrows">
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/woman-perfume" className="sf-with-ul">Products</ALink>
                    ...
                    <li>
                        <a href="https://1.envato.market/DdLk5" className="nolink" target="_blank">Buy Porto!</a>
                    </li>
                </ul>
            </nav>
        </>
