    ...
    return (
        <>
            ...
            <aside className={ `sidebar-product col-lg-3 mobile-sidebar ${adClass}` }>
                <StickyBox className="sticky-wrapper sticky-sidebar" offsetTop={ 90 }>
                    <div className="widget">
                        <h3 className="widget-title text-uppercase">Featured Products</h3>
                    ...
                    <div className="widget widget-block">
                        <h3 className="widget-title text-uppercase">Custom HTML Block</h3>

                        <div className="widget-body">
                            <h4 className="widget-subtitle font1">This is a custom sub-title.</h4>
                    ...
                    <div className="widget widget-banner">
                        <div className="home-banner pb-0 mb-2 mb-lg-0">
                            <figure style={ { backgroundColor: '#222529' } }>
                                <LazyLoadImage
                                    alt="banner"
