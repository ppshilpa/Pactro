...
function ShopImage () {
    ...
    useEffect( () => {
        let offset = document.querySelector( '.main-content-wrapper' ).getBoundingClientRect().top + window.pageYOffset - 58;
        setTimeout( () => {
            ...
            <div className="container">
                <div className="row main-content-wrapper">
                    <div className="col-lg-9">
                        <div className="category-banner-container custom-category-banner pt-0 pb-0 mb-2">
                            <div className="height-x1 mb-2 mb-lg-0">
