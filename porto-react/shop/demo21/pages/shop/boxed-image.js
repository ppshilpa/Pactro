            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-9 main-content">
                        <div className="category-banner-container bg-gray mb-2">
                            <div className="category-banner category-banner-bg"
                                style={ { background: "no-repeat 60%/cover url('images/home/banners/shop-banner-bg.jpg')" } }>
                                <div className="container">
                                    <div className="row">
                                        <div className="col-md-6 d-flex justify-content-md-center">
                                            <div>
                                                <h4 className="font1 font-weight-normal ls-0 text-uppercase m-b-2">start the revolution</h4>
                                                ...
                                                <ALink href="/shop" className="btn btn-dark btn-buy ml-0 font1">BUY NOW</ALink>
                                            </div>
                                        </div>
                                    </div>
                                </div>
