            ...
            <nav className="main-nav w-100">
                <ul className="menu sf-js-enabled sf-arrows">
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/blue-back-pack-one" className="sf-with-ul">Products</ALink>
                    ...
                    <li className="float-right">
                        <a href="https://1.envato.market/DdLk5" className="pl-5" target="_blank">Buy Porto!<span className="tip tip-hot">Hot</span></a>
                    </li>
                </ul>
            </nav>
        </>
