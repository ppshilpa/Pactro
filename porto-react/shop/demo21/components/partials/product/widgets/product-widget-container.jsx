                    ...
                    <div className="col-lg-3 col-sm-6 pb-5 pb-lg-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title ls-n-10 pb-2">Featured Products</h4>
                                    {
                    ...
                    <div className="col-lg-3 col-sm-6 pb-5 pb-lg-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title ls-n-10 pb-2">Best Selling Products</h4>
                                    {
                    ...
                    <div className="col-lg-3 col-sm-6 pb-5 pb-sm-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title ls-n-10 pb-2">Latest Products</h4>
                                    {
                    ...
                    <div className="col-lg-3 col-sm-6 pb-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title ls-n-10 pb-2">Top Rated Products</h4>
