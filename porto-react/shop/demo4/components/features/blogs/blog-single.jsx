                    ...
                    <div className="post-body">
                        ...
                        <div className="post-share">
                            ...
                            <div className="social-icons">
                                <ALink href="#" className="social-icon social-facebook" title="Facebook">
                                    <i className="icon-facebook"></i>
                                </ALink>
                                <ALink href="#" className="social-icon social-twitter" title="Twitter">
                                    <i className="icon-twitter"></i>
                                </ALink>
                                <ALink href="#" className="social-icon social-linkedin" title="Linkedin" >
