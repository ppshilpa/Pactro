            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-9 main-content">
                        <div className="category-banner banner text-uppercase small-banner mb-2"
                            style={ {
                                backgroundImage: "url(images/banners/banner-top.jpg)"
                            } }>
                            <div className="row">
                                < div className="pb-5 pb-md-0 col-sm-5 col-lg-5 offset-1">
                                    <h3 className="mb-2 ls-10">Electronic<br />Deals</h3>
                                    <ALink href="/shop" className="btn btn-dark btn-black ls-10">Get Yours!</ALink>
                                </div>
                                <div className="col-sm-4 offset-sm-0 offset-1">
                                    <div className="coupon-sale-content">
                                        <h4 className="m-b-2 coupon-sale-text bg-white ls-10 text-transform-none">Exclusive
											COUPON</h4>
