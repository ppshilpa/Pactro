            ...
            <nav className="main-nav">
                <ul className="menu sf-js-enabled sf-arrows">
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/right-sidebar/avengers-2-age-of-ultron" className="sf-with-ul">Products</ALink>
                    ...
                    <li className={ `d-none d-xl-block ${ pathname === '/pages/about-us' ? 'active' : '' }` }>
