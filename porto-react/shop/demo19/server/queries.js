...
export const GET_HOME_DATA = gql`
    query indexData($productsCount: Int) {
        fashionAndClothes: products(demo: ${DEMO}, category: "fashion-and-clothes", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
        electronicAndComputer: products(demo: ${DEMO}, category: "electronics-and-computers", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
        toyAndGame: products(demo: ${DEMO}, category: "toys-and-games", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
        ...
        sportsAndFitness: products(demo: ${DEMO}, category: "sports-and-fitness", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
        giftAndGadget: products(demo: ${DEMO}, category: "gifts-and-gadgets", from: 0, to: $productsCount ) {
            data {
                ...ProductSimple
            }
        }
