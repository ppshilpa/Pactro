...
export default function Header ( { adClass = '' } ) {
    ...
    return (
        <header className={ `header ${ adClass }` }>
            <div className="header-top">
                <div className="container">
                    ...
                    <div className="header-right">
                        <p className="top-message text-uppercase d-none d-xl-block">Free returns. Standard shipping orders $99+</p>

                        <span className="separator"></span>

                        <div className="header-dropdown dropdown-expanded mx-3 px-1 dropdown-links">
            ...
            <div className="header-middle sticky-header mobile-sticky">
                <div className="container">
                    ...
                    <div className="header-right w-lg-max">
                        ...
                        <ALink href="/pages/wishlist" className="header-icon btn-wishlist pl-1" title="wishlist"><i
            ...
            <div className="header-bottom sticky-header d-lg-block d-none desktop-sticky">
                <div className="container">
                    <div className="header-left">
                        <ALink href="/" className="logo">
                            <img src="images/logo-white.png" className="white-logo sticky-logo" alt="Porto Logo"
                                width="110" height="46" />
                        </ALink>
                    </div>
