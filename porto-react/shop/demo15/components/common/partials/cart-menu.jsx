...
function CartMenu(props) {
    ...
    return (
        <div className="dropdown cart-dropdown">
            <a href="#" title="Cart" className={`dropdown-toggle dropdown-arrow cart-toggle ${props.sticky ? '' : 'd-flex align-items-center'}`} onClick={toggleCart}>
