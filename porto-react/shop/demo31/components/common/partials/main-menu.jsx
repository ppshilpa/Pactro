            ...
            <nav className="main-nav">
                <ul className="menu sf-js-enabled sf-arrows">
                    <li className={ pathname.startsWith( '/shop' ) ? 'active' : '' }>
                        <ALink href="/shop" className="sf-with-ul"><i className="icon-joystick font-size-lg"></i>Games</ALink>
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/war-3" className="sf-with-ul"><i className="icon-bars mr-3"></i>Products</ALink>
