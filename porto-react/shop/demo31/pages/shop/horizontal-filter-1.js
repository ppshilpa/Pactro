...
function ShopHorizontalOne () {
    ...
    return (
        <main className="main">
                ...
                <nav aria-label="breadcrumb" className="breadcrumb-nav mb-1">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item"><ALink href="/">Home</ALink></li>
                        {
                            query.category ?
                                <>
                                    <li className="breadcrumb-item"><ALink href="/shop" scroll={ false }>Games</ALink></li>
                                    {
            ...
            <div className="container">
                <nav className="toolbox sticky-header horizontal-filter mobile-sticky mb-1 pt-3 pb-3 pb-lg-0 bg-transparent">
