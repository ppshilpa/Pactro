...
function ProductSidebarOne ( props ) {
    ...
    return (
        <>
            ...
            <aside className={ `sidebar-product col-lg-3 mobile-sidebar skeleton-body skel-shop-products font2 ${ adClass } ${ loading ? '' : 'loaded' }` }>
                <StickyBox className="sticky-wrapper" offsetTop={ 80 }>
                    {
                        loading ?
