...
function ProductStickyBoth () {
    ...
    return (
        <main className="main">
            <nav aria-label="breadcrumb" className="breadcrumb-nav font2">
            ...
            <div className="product-both-info-bottom bg-gray font2">
                <div className="container">

                    <div className="align-items-center row mb-0">
                        <div className="col-md-4 col-sm-6">
                            <h3 className="heading border-0"><strong>INCREDIBLE QUALITY</strong></h3>
                        ...
                        <div className="col-md-4 col-sm-6">
                            <h3 className="heading border-0 text-right"><strong>ULTRA BOOST</strong></h3>
                            ...
                            <h3 className="heading border-0 text-right"><strong>NOISE REDUCTION</strong></h3>
