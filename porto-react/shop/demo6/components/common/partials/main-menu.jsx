    ...
    return (
        <>
            <nav className="main-nav w-100">
                <ul className="menu sf-js-enabled sf-arrows ls-n-10">
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/men-black-jacket" className="sf-with-ul">Products</ALink>
                    ...
                    <li className={ pathname === '/pages/blog' ? 'active' : 'blog-link' }>
                        <ALink href="/pages/blog">Blog</ALink>
                    </li>

                    <li className="float-right">
                        <a href="https://1.envato.market/DdLk5" className="pl-15" target="_blank">Buy Porto!</a>
                    </li>
                </ul>
            </nav>
        </>
