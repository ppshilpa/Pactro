                                                ...
                                                <ul ref={ setCollapsibleElement }>
                                                    <li>
                                                        <SlideToggle collapsed={ true }>
                                                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                                <>
                                                                    <a href="#" className={ `${ toggleState.toLowerCase() }` }>VARIATION1
                                                    ...
                                                    <li>
                                                        <SlideToggle collapsed={ true }>
                                                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                                <>
                                                                    <a href="#" className={ `${ toggleState.toLowerCase() }` }>VARIATION2
                                                                    <span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span>
                                                                    </a>
                                                                    <ul ref={ setCollapsibleElement }>
                                                                        {
                            ...
                            <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                                {
                                    <SlideToggle collapsed={ true }>
                                        { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                            <>
                                                <ALink href="/product/default/men-black-jacket" className={ `${ toggleState.toLowerCase() }` }>Products<span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span></ALink>
                                                ...
                                                <ul ref={ setCollapsibleElement }>
                                                    <li>
                                                        <SlideToggle collapsed={ true }>
                                                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                                <>
                                                                    <a href="#" className={ `${ toggleState.toLowerCase() }` }>PRODUCT PAGES
                                                                    <span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span>
                                                                    </a>
                                                                    <ul ref={ setCollapsibleElement }>
                                                                        {
                                                    ...
                                                    <li>
                                                        <SlideToggle collapsed={ true }>
                                                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                                <>
                                                                    <a href="#" className={ `${ toggleState.toLowerCase() }` }>PRODUCT LAYOUTS
                                                                    <span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span>
                                                                    </a>
                                                                    <ul ref={ setCollapsibleElement }>
                                                                        {
                                    ...
                                    { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <>
                                            ...
                                            <ul ref={ setCollapsibleElement }>
                                                ...
                                                <li><ALink href="/pages/account">Account</ALink></li>
