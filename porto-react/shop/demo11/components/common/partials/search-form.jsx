        ...
        <div className="header-icon header-search header-search-inline header-search-category d-none d-sm-block border-left-0 mb-0">
            ...
            <form action="#" method="get" onSubmit={(e) => onSubmitSearchForm(e)}>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control bg-transparent" placeholder="Search Products..." value={search}
                        required onChange={(e) => onSearchChange(e)} />


                    <button className="btn icon-magnifier bg-transparent border-left-0" title="search" type="submit"></button>
