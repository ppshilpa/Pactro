        ...
        <>
            <div className={ `skel-pro skel-extended-detail ${adClass}` }></div>
            {
                ...
                <div className={ `product-single-details ${adClass}` }>
                    ...
                    {
                        product.variants.length > 0 ?
                            <div className="product-filters-container d-flex align-items-center flex-wrap align-items-center justify-content-xl-end mb-0 border-bottom-0">
                                {
                                    attrs.colors.length > 0 ?
                                        <div className="product-single-filter select-custom d-flex align-items-center mb-2 mr-sm-5">
                                            <label className="mr-0">Brand:</label>
...

                                {
                                    attrs.sizes.length > 0 ?
                                        <div className="product-single-filter select-custom d-flex align-items-center mb-2 mr-lg-5">
                                            <label className="mr-0">Size:</label>
