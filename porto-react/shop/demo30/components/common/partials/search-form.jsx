    ...
    return (
        type == 1 ?
            <div className="header-icon header-search header-search-popup header-search-category d-none d-sm-block d-lg-none">
                ...
                <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                    <div className="header-search-wrapper">
                        <input type="search" className="form-control" name="ee" id="q" placeholder="I'm searching for..." value={ search }
                            required onChange={ ( e ) => onSearchChange( e ) } />

                        <button className="btn icon-magnifier border-0" type="submit"></button>
            ...
            <div className="header-search">
                <form className="mb-0" action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                    <div className="submit-wrapper">
                        <input type="search" className="form-control font2 bg-transparent border-0" name="form" id="from" placeholder="I'm searching for..." value={ search }
                            required onChange={ ( e ) => onSearchChange( e ) } />
