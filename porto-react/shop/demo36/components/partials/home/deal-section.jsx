...
function DealSection ( { products } ) {
    return (
        <section className="deal-products-section">
            <h2 className="section-title d-flex align-items-center text-transform-none"><i
                className="icon-percent-shape"></i>Special Offers</h2>
                            ...
                            <div className="row row-joined">
                                {
                                    products ?
                                        products.filter( ( item ) => (
                                            ...
                                            <div className="col-xl-3 col-sm-4 col-6" key={ "All Products:" + index }>
                                                <ProductOne
