    ...
    return (
        <OwlCarousel adClass="home-slider nav-circle mb-2" options={ HomeSlider }>
            <div className="home-slide home-slide1 banner">
                ...
                <div
                    className="container d-flex align-items-sm-center justify-content-sm-between justify-content-center flex-column flex-sm-row">
                    ...
                    <div className="banner-content content-right">
                        <Reveal keyframes={ fadeInUpShorter } delay={ 200 } duration={ 1000 }>
                            <>
                                ...
                                <h5 className="text-price text-transform-none mb-0">from <span>$299.99</span></h5>
            ...
            <div className="home-slide home-slide2 banner banner-md-vw">
                ...
                <div
                    className="container d-flex align-items-sm-center justify-content-center justify-content-sm-between flex-column-reverse flex-sm-row">
                        ...
                        <Reveal keyframes={ fadeInUpShorter } delay={ 200 } duration={ 1000 }>
                            <>
                                ...
                                <h5 className="coupon-sale-text">
                                    <span>from</span>
                                    <b className="text-white align-middle"><sup>$</sup><em
                                        className="align-text-top">1</em><sup>99</sup></b>
                                </h5>
                                <ALink href="/shop" className="btn btn-dark btn-lg">Shop Now</ALink>
                            </>
                        </Reveal>
