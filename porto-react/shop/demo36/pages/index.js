    ...
    return (
        <>
            <main className="home" >
                ...
                <div className={ `bg-gray skeleton-body skel-shop-products ${ loading ? '' : 'loaded' }` }>
                    <div className="container">
                        <ElectronicCollection products={ electronic } />
                        <GiftCollection products={ giftAndGadgets } />
                        <GardenCollection latest={ latest } bestSelling={ bestSelling } topRated={ topRated } loading={ loading } />
                        <BrandSection />
                        <SelectedCollection latest={ latest } bestSelling={ bestSelling } topRated={ topRated } />
