                                ...
                                { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                    <>
                                        ...
                                        <div className="product-single-filter" ref={ setCollapsibleElement }>
                                            ...
                                            <a className="font1 text-uppercase clear-btn mb-2 ml-0" href="#" onClick={ clearVariation }>Clear</a>
                                        </div>
                                    </>
                                ) }
                            </SlideToggle>
...
export default connect( mapStateToProps, { ...WishlistAction, ...CartAction } )( ProductDetailThree );