                    ...
                    <div className="product-detail">
                        {
                            product.index > -1 ?
                                product.index === 0 ?
                                    <ALink className="product-name" href={ `/product/default/${product.slug}` }>{ product.name + ' - Regular' }</ALink>
                                    :
                                    <ALink className="product-name" href={ `/product/default/${product.slug}` }>{ product.name + ' - Extended' }</ALink>
                                :
