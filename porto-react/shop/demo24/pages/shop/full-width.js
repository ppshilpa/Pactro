...
function Shop () {
    ...
    useEffect( () => {
        let offset = document.querySelector( '.main-content' ).getBoundingClientRect().top + window.pageYOffset - 40;
        ...
        getProducts( {
            variables: {
                search: query.search,
                ratings: query.ratings ? query.ratings.split( ',' ).map( item => parseInt( item ) ) : [],
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-9 main-content">
                        ...
                        <ProductsGrid products={ products } loading={ loading } perPage={ perPage } addClass="three-col" />
