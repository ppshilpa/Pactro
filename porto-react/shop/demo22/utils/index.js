...
export function stickyHeaderHandler ( stickyHeader, offsetTop, height ) {
    ...
    if ( document.querySelector( '.header.home .sticky-header' ) ) {
        top = document.querySelector( '.intro-section' ).getBoundingClientRect().top + window.pageYOffset + document.querySelector( '.intro-section' ).offsetHeight;
    }
