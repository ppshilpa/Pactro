...
import BestProducts from '../../../components/partials/product/widgets/best-products';
    ...
    return (
        <main className="main">
            ...
            <div className="container-fluid mb-3">
                <RelatedProducts adClass={ `skeleton-body skel-shop-products ${ loading ? '' : 'loaded' }` } products={ related } loading={ loading } />
                <BestProducts adClass="mt-3" isContainer={ false } />
            </div>

            <BrandSection adClass="custom-brands-section" />
        </main >
    )
}
