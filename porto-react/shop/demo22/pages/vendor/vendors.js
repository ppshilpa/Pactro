    ...
    return (
        <main className="main">
            ...
            <div className="container">
                            ...
                            <>
                                <div className="toolbox toolbox-store sticky-header mobile-sticky">
                                    ...
                                    <div className="toolbox-item layout-modes">
                                        <ALink href="/vendor/vendors" className="layout-btn btn-grid active" title="Grid">
                                            <i className="icon-mode-grid"></i>
                                        </ALink>
                                        <ALink href="/vendor/vendor-list" className="layout-btn btn-list" title="List">
                ...
                <div className="row row-lg mt-2 position-relative" style={ { zIndex: '3', backgroundColor: '#fff' } } >
                    ...
                    <div className="col-md-4">
                        <div className="store-default no-banner">
                            <div className="store-header">
                                <figure>
                                    <LazyLoadImage
                                        alt="vendor"
