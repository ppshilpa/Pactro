...
function ShopSidebarOne ( props ) {
    ...
    return (
        <>
            ...
            <aside className={ `sidebar-shop col-lg-3 mobile-sidebar skeleton-body skel-shop-products ${ props.adClass } ${ !loading ? 'loaded' : '' } ${ props.display === 'none' ? 'd-lg-none' : '' } ${ props.right ? 'sidebar-right' : 'order-lg-first' }` }>
                <StickyBox className="sidebar-wrapper" offsetTop={ 70 }>
                    ...
                    {
                        ( query.category || query.sizes || query.colors || query.min_price || query.max_price ) && <div className="widget pb-5">
