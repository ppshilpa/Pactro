                            ...
                            <li className={ pathname.startsWith( '/vendor' ) ? 'active' : '' }>
                                <SlideToggle collapsed={ true }>
                                    { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                        <>
                                            <a href="/vendor" className={ `${ toggleState.toLowerCase() }` }>Vendor<span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span>
                                            </a>
                            ...
                            <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                                {
                                    <SlideToggle collapsed={ true }>
                                        { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                            <>
                                                <ALink href="/product/default/3-d-printer" className={ `${ toggleState.toLowerCase() }` }>Products<span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span></ALink>
