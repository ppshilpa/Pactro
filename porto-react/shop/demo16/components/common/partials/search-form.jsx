...
function SearchForm() {
    ...
    return (
        <div className="header-search header-search-popup header-search-category d-none d-sm-block">
            <a href="#" className="search-toggle btn icon-magnifier p-0 mr-2 ml-2" role="button" onClick={onSearchClick}></a>
            <form action="#" method="get" onSubmit={(e) => onSubmitSearchForm(e)}>
                <div className="header-search-wrapper rounded-0">
                    ...
                    <button className="btn icon-magnifier rounded-0 p-0" title="search" type="submit"></button>
