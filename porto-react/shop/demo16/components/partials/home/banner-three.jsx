...
export default function BannerThree () {
    return (
        <section className="section-8 large-banner slider-left overflow-hidden section-bg bg-img bg-fixed" style={ { backgroundImage: 'url(images/home/bg-7.jpg)' } }>
            <div className="container position-relative h-100">
                <div className="banner-layer banner-layer-middle float-right ml-auto text-left">
                    ...
                    <Reveal keyframes={ blurIn } delay={ 700 } duration={ 1200 }>
                        <h3 className="text-uppercase rotated-upto-text mb-0 position-relative text-dark"><small>Up to</small>50% Off</h3>
                    </Reveal>
                    ...
                    <Reveal keyframes={ blurIn } delay={ 1900 } duration={ 1200 }>
                        <>
                            <h5 className="text-uppercase d-inline-block mb-0 ls-n-20 pr-1 pt-2 text-dark">Starting at&nbsp;
