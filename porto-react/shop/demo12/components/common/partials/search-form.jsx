...
function SearchForm() {
    ...
    return (
        <div className="header-search header-search-popup header-search-category d-none d-sm-block">
            <a href="#" className="search-toggle header-icon" role="button" onClick={onSearchClick}><i className="icon-search-3"></i></a>
            <form action="#" method="get" onSubmit={(e) => onSubmitSearchForm(e)}>
                <div className="header-search-wrapper">
                    ...
                    <button className="btn icon-search-3 bg-white" title="search" type="submit"></button>
