            ...
            <div className="header-top">
                <div className="container">
                    ...
                    <div className="header-right header-dropdowns ml-0 ml-sm-auto w-sm-100">
                        ...
                        <div className="header-dropdown mr-sm-auto mr-sm-3 mr-md-0">
                ...
                <div className="container">
                    <div className="header-left col-lg-2 w-auto pl-0">
                        ...
                        <ALink href="/" className="logo">
                            ...
                            <img src="images/logo-white.png" width="101" height="44" alt="Porto Logo" />
                        </ALink>
                    </div>
                    ...
                    <div className="header-right w-lg-max">
                        ...
                        <ALink href="/pages/login" className="header-icon header-icon-user login-link" title="login"><i className="icon-user-2"></i></ALink>

                        <ALink href="/pages/wishlist" className="header-icon pb-md-1" title="wishlist"><i className="icon-wishlist-2"></i></ALink>
