        ...
        <div className={`product-default inner-quickview inner-icon media-with-lazy ${adClass}`}>
            <figure>
                <ALink href={`/product/${link}/${product.slug}`}>
                    ...
                    <LazyLoadImage
                        alt="product"
                        src={process.env.NEXT_PUBLIC_SERVER_URL + product.pictures[0].url}
                        threshold={500}
                    ...
                    />
                    {
                        product.pictures.length >= 2 ?
                            <LazyLoadImage
                                alt="product"
                                src={process.env.NEXT_PUBLIC_SERVER_URL + product.pictures[1].url}
                                threshold={500}
                                effect="black and white"
...

                {
                    ...
                    <div className="product-countdown-container">
                        ...
                        <div className="product-countdown countdown-compact" data-until={`${product.until}`} data-compact="true">
                            <span className="days">
                                <span className="font-weight-extra-bold mr-1">237 </span>
                                                                            DAY
                                                    ...
                                                    <li key={`filter-color-${index}`} className={`${item.name === color ? 'active' : ''} ${isDisabled('color', item.name) ? 'disabled' : ''}`}>
                                                        {
                                                            item.thumb ?
                                                                <a href="#" className="filter-thumb p-0" onClick={(e) => selectColor(item.name, e)}>
                                                                    <LazyLoadImage
                                                                        src={process.env.NEXT_PUBLIC_SERVER_URL + item.thumb.url}
                                                                        alt='product thumb'
