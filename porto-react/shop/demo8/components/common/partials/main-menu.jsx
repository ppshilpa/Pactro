            ...
            <nav className="main-nav w-100">
                <ul className="menu sf-js-enabled sf-arrows w-100">
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/brown-leather-sofa" className="sf-with-ul">Products</ALink>
                    ...
                    <li className="float-right">
                        <a href="https://1.envato.market/DdLk5" className="pl-5 m-0 pr-0" target="_blank">Buy Porto!</a>
                    </li>
                    <li className="float-right">
