                                                ...
                                                <ul ref={ setCollapsibleElement }>
                                                    <li>
                                                        <SlideToggle collapsed={ true }>
                                                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                                <>
                                                                    <a href="#" className={ `${ toggleState.toLowerCase() }` }>VARIATION 1
                                                    ...
                                                    <li>
                                                        <SlideToggle collapsed={ true }>
                                                            { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                                                <>
                                                                    <a href="#" className={ `${ toggleState.toLowerCase() }` }>VARIATION 2
                                                                    <span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span>
                                                                    </a>
                                                                    <ul ref={ setCollapsibleElement }>
                                                                        {
                            ...
                            <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                                {
                                    <SlideToggle collapsed={ true }>
                                        { ( { onToggle, setCollapsibleElement, toggleState } ) => (
                                            <>
                                                <ALink href="/product/default/porto-sofa" className={ `${ toggleState.toLowerCase() }` }>Products<span className="mmenu-btn" onClick={ e => { e.preventDefault(); onToggle(); } }></span></ALink>
