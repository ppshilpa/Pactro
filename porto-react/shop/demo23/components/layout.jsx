                    ...
                    showTopNotice ?
                        <div className="top-notice">
                            <div className="container-fluid text-center text-dark">
                                <i className="icon-shipping align-middle"></i>
                                <b className="text-uppercase">Free Shipping</b>
                                &nbsp;on orders of $80 or more! Code:&nbsp;
                                <b className="text-uppercase">PortoMagic</b>&nbsp;| Restrictions Apply.&nbsp;
                                <a href="#" className="text-dark">See All Offers</a>
                            </div>
