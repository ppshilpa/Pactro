...
function SearchForm ( props ) {
    ...
    return (
        <div className={ `header-search header-search-popup header-search-category text-right ${props.adClass}` }>
            <a href="#" className="search-toggle" role="button" onClick={ onSearchClick }><i className="icon-magnifier mr-2"></i><span>Search</span></a>

            <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control" name="q" placeholder="I'm searching for..." value={ search }
                        required onChange={ ( e ) => onSearchChange( e ) } />
                    <div className="select-custom">
                        <select name="cat" value={ cat } onChange={ ( e ) => onCatSelect( e ) }>
                    ...
                    <button className="btn icon-magnifier bg-dark text-white" title="search" type="submit"></button>
