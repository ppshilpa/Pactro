            ...
            <article className={ `post media-with-lazy ${adClass}` }>
                ...
                <div className="post-body">
                    ...
                    <div className="post-content">
                        <p>{ blog.content }<ALink href={ `/pages/blog/${blog.slug}` } className="read-more d-inline-flex align-items-center">read more<i className="fas fa-angle-right"></i></ALink></p>
                    </div>
                </div>
            </article >
            {
