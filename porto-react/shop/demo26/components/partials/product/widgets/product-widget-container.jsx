                    ...
                    <div className="col-lg-3 col-sm-6 pb-5 pb-lg-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title pb-2 mb-1">Featured Products</h4>
                                    {
                    ...
                    <div className="col-lg-3 col-sm-6 pb-5 pb-lg-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title pb-2 mb-1">Best Selling Products</h4>
                                    {
                    ...
                    <div className="col-lg-3 col-sm-6 pb-5 pb-sm-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title pb-2 mb-1">Latest Products</h4>
                                    {
                    ...
                    <div className="col-lg-3 col-sm-6 pb-0">
                        {
                            loading ?
                                ...
                                <>
                                    <h4 className="section-sub-title pb-2 mb-1">Top Rated Products</h4>
