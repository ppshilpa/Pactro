...
function SearchForm ( props ) {
    ...
    return (
        <div className={ `header-search header-search-inline header-search-category w-lg-max text-right ${props.adClass}` }>
            <a href="#" className="search-toggle" role="button" onClick={ onSearchClick }><i className="icon-magnifier mr-2"></i></a>

            <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control font-italic" name="q" id={ `${props.type == 1 ? 'q' : 'qqq'}` } placeholder="I'm searching for..." value={ search }
