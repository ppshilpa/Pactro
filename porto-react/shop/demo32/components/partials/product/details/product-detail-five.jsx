...
function ProductDetailFive ( props ) {
    ...
    return (
        <>
            <div className={ `col-xl-3 ${ adClassOne }` }>
                        ...
                        <div className="product-single-details">

                            {
                                ...
                                <>
                                    ...
                                    <div className="ratings-container flex-wrap">
                                        <div className="product-ratings">
                                            <span className="ratings" style={ { width: `${ 20 * product.ratings }%` } }></span>
                                            <span className="tooltiptext tooltip-top">{ product.ratings.toFixed( 2 ) }</span>
                                        </div>

                                        <a href="#" className="rating-link pl-xl-0 pt-2 pb-2">( { product.reviews > 0 ? `${ product.reviews } Reviews` : 'There are no reviews yet.' } )</a>
                                    </div>
            ...
            <div className={ `col-xl-3 ${ adClassTwo }` } style={ { zIndex: '2' } }>
