    ...
    return (
        <>
            <nav className="main-nav w-100">
                <ul className={ `menu sf-js-enabled sf-arrows ${ pathname !== '/' ? 'w-100' : '' }` }>
                    ...
                    <li className={ pathname.startsWith( '/product' ) ? 'active' : '' }>
                        <ALink href="/product/default/low-shoes" className="sf-with-ul">Products</ALink>
                    ...
                    <li className={ `sf-with-ul ${ isOtherPage() ? 'active' : '' }` }>
