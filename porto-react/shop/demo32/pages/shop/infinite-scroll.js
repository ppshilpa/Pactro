...
function ShopInfinite () {
    ...
    const products = data && [ ...data.products.data, ...newProducts ];
    const total = data && data.products.total;

    useEffect( () => {
        let offset = document.querySelector( '.products-group' ).getBoundingClientRect().top + window.pageYOffset - 58;
        setTimeout( () => {
                            ...
                            <div className="row products-group">
                                <div className="col-lg-12">
                                    <nav className="toolbox sticky-header mobile-sticky">
                                        ...
                                        <div className="toolbox-right">
                                            <div className="toolbox-item layout-modes">
                                                <ALink href="/shop" className="layout-btn btn-grid active" title="Grid">
                                    ...
                                    <ReactScroll
                                        ...
                                        <ProductsGrid products={ products } loading={ loading } perPage={ products ? products.length + 4 : 12 } />
                                    </ReactScroll>
                                </div>
                            </div>
                        </div>
