        ...
        <main className="main pb-5">
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className={ `${showsidebar ? "col-xl-8cols col-lg-6 col-md-8" : "col-xl-8cols col-lg-9 col-12"}` }>
                        <div className={ `${showsidebar ? "container p-0" : ""}` }>
                            ...
                            <div className="row">
                                <div className={ `main-content ${showsidebar ? 'col-lg-12' : 'col-12'}` }>
