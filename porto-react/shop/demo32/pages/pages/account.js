                ...
                <div className="row">
                    ...
                    <div className="col-xl-8cols col-lg-6 col-md-8">
                        <div className="container p-0">
                            ...
                            <div className="account-container custom-account-container">
                                <Tabs selectedTabClassName="active" selectedTabPanelClassName="active show" defaultIndex={ 0 } className="tab">
                                    <div className="row">
                                        <div className="sidebar widget widget-dashboard col-xl-3 order-0">
                                        ...
                                        <div className="col-xl-9 order-lg-last order-1 tab-content">
                                        ...
                                        <span className="btn btn-link link-to-tab" onClick={ () => document.getElementById( 'link-address' ).click() }> shipping and billing addresses</span>, and <span className="btn btn-link link-to-tab" onClick={ () => document.getElementById( 'link-account' ).click() }>edit your password and account
                                            details.</span>
                                                    ...
                                                    <div className="row row-lg">
                                                        <div className="col-6 col-xl-4 pb-4">
                                                            <div className="feature-box text-center" onClick={ () => document.getElementById( 'link-order' ).click() }>
                                                        ...
                                                        <div className="col-6 col-xl-4 pb-4">
                                                            <div className="feature-box text-center" onClick={ () => document.getElementById( 'link-download' ).click() }>
                                                                <span className="link-to-tab"><i
                                                        ...
                                                        <div className="col-6 col-xl-4 pb-4">
                                                            <div className="feature-box text-center" onClick={ () => document.getElementById( 'link-address' ).click() }>
                                                        ...
                                                        <div className="col-6 col-xl-4 pb-4">
                                                            <div className="feature-box text-center" onClick={ () => document.getElementById( 'link-account' ).click() }>
