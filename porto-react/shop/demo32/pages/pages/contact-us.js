...
export default function ContactUs () {
    return (
        <main className="main contact-two pb-5">
                ...
                <div className="row">
                    ...
                    <div className="col-xl-8cols col-lg-6 col-md-8">
                        <div className="container p-0">
                            ...
                            <div className="row mb-4 mb-lg-1">
                                ...
                                <div className="col-xl-6">
                                    ...
                                    imperdiet varius. In eu ipsum vitae velit congue iaculis vitae at risus. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    ...
                                    <div className="contact-time">
                                        ...
                                        <div className="porto-sicon-box d-flex align-items-center">
                                            ...
                                            <h3 className="porto-sicon-title font1 ls-n-10">Monday - Friday 9am to 5pm</h3>
                                        </div>
                                        ...
                                        <div className="porto-sicon-box  d-flex align-items-center">
                                            ...
                                            <h3 className="porto-sicon-title font1 ls-n-10">Saturday - 9am to 2pm</h3>
                                        </div>

                                        <div className="porto-sicon-box d-flex align-items-center">
                                            <div className="porto-icon"><i className="far fa-clock"></i></div>
                                            <h3 className="porto-sicon-title font1 ls-n-10">Sunday - Closed</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
