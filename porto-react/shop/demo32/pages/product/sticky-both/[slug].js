                        ...
                        <div className="container p-0">
                            ...
                            <div className={ `product-single-container product-single-default product-both-info` }>
                                ...
                                <div className="row mb-lg-3">
                                    ...
                                    <ProductMediaFive product={ product } adClass="col-xl-6 mb-0" subClass="col-lg-12" />
                                </div>
                            </div>
                            ...
                            <div className="product-both-info-bottom bg-gray pl-5 pr-5">
                                <div className="container">
                            ...
                            minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex eacommodo</p>
                                        ...
                                        <div className="col-xl-4 d-md-block d-none"></div>

                                        <div className="col-xl-4">
                                            <h3 className="heading text-right"><strong>ULTRA BOOST</strong></h3>

                                            <p className="text-xl-right">Sed do eiusmod tempor incididunt ut labore et dolore magna
                            aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo</p>
                                            ...
                                            <p className="text-xl-right">Sed do eiusmod tempor incididunt ut labore et dolore magnaut aliquip ex ea commodo</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
