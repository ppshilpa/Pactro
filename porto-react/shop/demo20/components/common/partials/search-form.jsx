...
function SearchForm ( props ) {
    ...
    return (
        <div className={ `header-icon header-search header-search-category text-dark ${props.type == 1 ? ' header-search-popup d-none d-sm-block' : 'header-search-inline  d-block'}` }>
            {
                props.type == 1 ?
                    <a href="#" className="search-toggle btn p-0" role="button" onClick={ onSearchClick }><i className="icon-search-3"></i></a>
                    :
                    <a href="#" className="search-toggle btn p-0 icon-search-3" role="button" onClick={ onSearchClick }></a>
            }

            <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control" name="q" id={ `${props.type == 1 ? 'search-one' : 'search-two'}` } placeholder="Search..." value={ search }
