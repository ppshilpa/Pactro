        ...
        <div className="header-search header-search-popup header-search-category d-none d-lg-block ml-xl-5">
            ...
            <form action="#" method="get" onSubmit={ ( e ) => onSubmitSearchForm( e ) }>
                <div className="header-search-wrapper">
                    <input type="search" className="form-control bg-white" name="q" id="q" placeholder="Search..." value={ search }
                    ...
                    <button className="btn bg-white icon-search-3" title="search" type="submit"></button>
