...
function ProductOne(props) {
    ...
    const { adClass = "", link = "default", product, featured, type, noaction } = props;
    ...
    return (
        <div className={`product-default left-details media-with-lazy ${adClass} ${type == 'widget' ? 'product-widget mb-2' : ''}`}>
            <figure>
                        ...
                        <div className="product-action">
                            {
                                product.variants.length > 0 ?
                                    ...
                                    : <a href="#" className="btn-icon btn-dark btn-add-cart product-type-simple" title="Add To Cart" onClick={onAddCartClick}><i
