                    ...
                    <div className="post-body">
                        ...
                        <div className="post-share">
                            ...
                            <div className="social-icons">
                                <a href="#" className="social-icon social-facebook" onClick={(e) => e.preventDefault()}
                                    title="Facebook">
                                    <i className="icon-facebook"></i>
                                </a>
                                <a href="#" className="social-icon social-twitter" title="Twitter" onClick={(e) => e.preventDefault()}>
                                    <i className="icon-twitter"></i>
                                </a>
                                <a href="#" className="social-icon social-linkedin" onClick={(e) => e.preventDefault()}
                                    title="Linkedin">
                                    <i className="fab fa-linkedin-in"></i>
                                </a>

                                <a href="#" className="social-icon social-mail" title="Email" onClick={(e) => e.preventDefault()}>
